...
/**
 * Array of the required attributes. This array maps SmartExam user data with LDAP attributes.
 */
$ldap_attr = array();
$ldap_attr['dn'] = 'dn';
 ...
 * This is the SmartExam group id to which the LDAP accounts belongs.
