...
define('K_TCEXAM_TITLE', 'SmartExam');


define('K_TCEXAM_DESCRIPTION', 'bsc final year project ');


define('K_TCEXAM_AUTHOR', 'Amin,Linda,Ashenafi,Afework and Mengestu ');
 ...
 */
define('K_TCEXAM_KEYWORDS', 'SmartExam, eExam, e-exam, web, exam');
