...
if ((isset($_REQUEST['expmode']) and ($_REQUEST['expmode'] > 0))
    ...
    switch ($expmode) {
        case 1: {
            $out_filename = 'smartexam_subject_'.$subject_id;
            break;
        }
        case 2: {
            $out_filename = 'smartexam_module_'.$module_id;
            break;
        }
        case 3: {
            $out_filename = 'smartexam_all_modules';
            break;
        }
        default: {
            $out_filename = 'smartexam_export';
            break;
        }
    }
...
function F_xml_export_questions($module_id, $subject_id, $expmode)
{
    ...
    $xml .= '<smartexamquestions version="'.K_TCEXAM_VERSION.'">'.K_NEWLINE;
    $xml .=  K_TAB.'<header';
    ...
    $xml .= K_TAB.'</body>'.K_NEWLINE;
    $xml .= '</smartexamquestions>'.K_NEWLINE;
