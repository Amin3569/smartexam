...
if ((isset($_REQUEST['expmode']) and ($_REQUEST['expmode'] > 0))
    ...
    switch ($expmode) {
        case 1: {
            $tsv_filename = 'smartexam_subject_'.$subject_id.'_'.date('YmdHi').'.tsv';
            break;
        }
        case 2: {
            $tsv_filename = 'smartexam_module_'.$module_id.'_'.date('YmdHi').'.tsv';
            break;
        }
        case 3: {
            $tsv_filename = 'smartexam_all_modules_'.date('YmdHi').'.tsv';
            break;
        }
        default: {
            $tsv_filename = 'smartexam_export_'.date('YmdHi').'.tsv';
            break;
        }
    }
