...
$pdf->SetCreator('SmartExam ver.'.K_TCEXAM_VERSION."");
$pdf->SetAuthor(PDF_AUTHOR);
$pdf->SetTitle($doc_title);
$pdf->SetSubject($doc_description);
$pdf->SetKeywords('SmartExam, '.$doc_title);
...
switch ($expmode) {
    case 1: {
        $pdf_filename = 'smartexam_subject_'.$subject_id.'_'.date('YmdHi').'.pdf';
        break;
    }
    case 2: {
        $pdf_filename = 'smartexam_module_'.$module_id.'_'.date('YmdHi').'.pdf';
        break;
    }
    case 3: {
        $pdf_filename = 'smartexam_all_modules_'.date('YmdHi').'.pdf';
        break;
    }
    default: {
        $pdf_filename = 'smartexam_export_'.date('YmdHi').'.pdf';
        break;
    }
}
